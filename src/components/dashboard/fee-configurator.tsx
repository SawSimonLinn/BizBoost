...
const InputField = ({ id, label, value, onChange, unit, type = "number", className, disabled = false }: { id: string; label: string; value: number | string; onChange: (value: string) => void; unit: string, type?: string, className?: string, disabled?: boolean }) => (
  ...
  export function FeeConfigurator({ 
    ...
    const handleLocalWeeklySaleChange = (index: number, value: string) => {
        ...
        // Don't auto-fill if the user clears the input
        if (value === '') {
    ...
    return (
      <Card>
        <CardHeader>
          ...
          <CardDescription>Adjust your period data and fee structure here to see real-time updates.</CardDescription>
        </CardHeader>
        <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
          ...
          <div className="space-y-4">
               ...
               <div className="space-y-1">
                   <Label htmlFor="total-sales" className="text-xs font-medium">Total Monthly Sales</Label>
                   <div className="relative">
                      <Input 
                        id="total-sales"
                        type="number"
                      ...
                      <Dialog open={isWeeklySalesDialogOpen} onOpenChange={setIsWeeklySalesDialogOpen}>
                       ...
                       <DialogContent>
                         <DialogHeader>
                           <DialogTitle>Enter Weekly Sales for {activePeriod.name}</DialogTitle>
                         </DialogHeader>
                         ...
                         <DialogFooter>
                           <Button type="button" variant="ghost" onClick={handleCancelWeeklySales}>Cancel</Button>
                 ...
                 <div className="space-y-1">
                    <Label htmlFor="inventory-cost" className="text-xs font-medium">Inventory Cost</Label>
                    <div className="relative">
                        <Input
                        id="inventory-cost"
                        type="number"
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-1">
                <Label htmlFor="royalty-fee" className="text-xs font-medium">Royalty Fee</Label>
                <div className="relative">
                    <Input
                    id="royalty-fee"
                    type="number"
              ...
              <div className="space-y-1">
                   <Label htmlFor="total-additional-fees" className="text-xs font-medium">Additional Franchisee Fees</Label>
                   <div className="relative">
                      <Input 
                      ...
                      <Dialog open={isFeesDialogOpen} onOpenChange={setIsFeesDialogOpen}>
                       ...
                       <DialogContent>
                         ...
                         <div className="space-y-2 rounded-lg border p-4 max-h-60 overflow-y-auto">
                            {localOtherExpenses.length === 0 && <p className="text-sm text-muted-foreground text-center py-4">No fees added yet.</p>}
                         ...
                         <form onSubmit={handleAddExpense} className="mt-4 flex items-end gap-2 border-t pt-4">
                            <div className="flex-grow">
                                 <Label htmlFor="new-expense-name" className="text-xs font-medium">New Fee Name</Label>
                                 <Input id="new-expense-name" placeholder="e.g., Tech Fee" value={newExpenseName} onChange={e => setNewExpenseName(e.target.value)} />
                            </div>
                            <div className="w-32">
                         ...
                         <DialogFooter>
                            <Button type="button" variant="ghost" onClick={() => setIsFeesDialogOpen(false)}>Cancel</Button>
                           <Button type="button" onClick={handleSaveFees}>Save Changes</Button>
                         </DialogFooter>
                       </DialogContent>
                      </Dialog>
                   </div>
