...
export function WelcomeModal({
  ...
  const [numWeeks, setNumWeeks] = React.useState(
    activePeriod.weeklySales.length.toString()
  );
      ...
      <DialogContent className="sm:max-w-md">
        ...
        <div className="space-y-4 py-4">
          <div className="space-y-1">
            <Label htmlFor="total-sales" className="text-sm font-medium">
              Total Monthly Sales
            </Label>
            <div className="relative">
              <Input
                ...
                <DialogContent>
                  ...
                  <div className="py-4 space-y-4">
                    <div>
                      ...
                      <RadioGroup
                        value={numWeeks}
                        onValueChange={handleWeekCountChange}
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      {localWeeklySales.map((sale, index) => (
                        <InputField
                          ...
                          value={sale}
                          onChange={(v) =>
                            handleLocalWeeklySaleChange(index, v)
                          }
                          unit="$"
                        />
                      ))}
                  ...
                  <DialogFooter>
                    <Button
                      type="button"
                      variant="ghost"
                      onClick={() => setIsWeeklySalesDialogOpen(false)}
                    >
                      Cancel
                    </Button>
          ...
          <div className="space-y-1">
            <Label htmlFor="inventory-cost" className="text-sm font-medium">
              Inventory Cost
            </Label>
