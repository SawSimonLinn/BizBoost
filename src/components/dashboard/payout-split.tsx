...
export function PayoutSplit({ franchisorCut, ownerCut }: PayoutSplitProps) {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle className="font-headline">Revenue Split</CardTitle>
        <CardDescription>
          Here's the breakdown of revenue between your take-home and business expenses.
        </CardDescription>
      </CardHeader>
      <CardContent>
        <div className="flex w-full h-12 rounded-full overflow-hidden bg-muted">
          <div 
            ...
            title={`Business Expenses & Fees: ${franchisorPercentage.toFixed(1)}%`}
          >
          ...
          <div 
            ...
            title={`Your Cut: ${ownerPercentage.toFixed(1)}%`}
          >
        ...
        <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
          <div className="p-4 rounded-lg bg-accent/10">
            <div className="flex items-center gap-2 text-accent font-semibold">
              ...
              <span>Business Expenses & Fees</span>
            </div>
